/** 
 * This class represents an hourly employee that earns an amount based on an hourly rate
 * 
 * @author Christopher Tam
 */
public class HourlyEmployee implements HourlyE{
  ...
  /**
   * Creates a new HourlyEmployee object
   ...
   * @return A string in the form of "number: last name, first name, Hourly Employee"
   */
  ...
  /**
   * Overrides the equals method inherited by object, checks if two HourlyEmployee objects are equal 
   * @param o An input (parameter) object
   * @return A boolean value that tells if the parameter object is equal to the instance HourlyEmployee
   */
  public boolean equals(Object o){
    if (o instanceof HourlyEmployee){
      // d stores the parameter object if it is an instance of HourlyEmployee 
      HourlyEmployee d = (HourlyEmployee) o;                         
  ...
  /** 
   * Checks if the parameter name (first,last) is equal to the name (first,last) of the instance HourlyEmployee
