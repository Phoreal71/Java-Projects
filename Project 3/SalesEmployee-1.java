/** 
 * This class represents a sales employee that earns a small salary plus a commission on every sale made
 * 
 * @author Christopher Tam
 */
public class SalesEmployee implements SalesE{
  ...
  /**
   * Creates a new SalesEmployee object.
   ...
   * @return A string in the form of "number: last name, first name, Sales Employee"
   */
  ...
  /**
   * Overrides the equals method inherited by object, checks if two SalesEmployee objects are equal 
   * @param o An input (parameter) object
   * @return A boolean value that tells if the parameter object is equal to the instance SalesEmployee
   */
  ...
  /** 
   * Checks if the parameter name (first,last) is equal to the name (first,last) of the instance SalesEmployee
